#Running this script requires manually changing the input dimension
if [ ! -d "./logs" ]; then
    mkdir ./logs
fi
...
do
  python -u run_RULExp.py \
    ...
    --gpu 1 \
    --patience 10 \
    --itr 1 --batch_size 32 --learning_rate 0.001 >logs/RUL/RMixMLP/Best/FD001.log
done
done
...
do
  python -u run_RULExp.py \
    ...
    --gpu 1 \
    --patience 10 \
    --itr 1 --batch_size 32 --learning_rate 0.001 >logs/RUL/RMixMLP/Best/FD002.log
done
done
...
do
  python -u run_RULExp.py \
    ...
    --gpu 1 \
    --patience 10 \
    --itr 1 --batch_size 32 --learning_rate 0.001 >logs/RUL/RMixMLP/Best/FD003.log
done
done
...
do
  python -u run_RULExp.py \
    ...
    --gpu 1 \
    --patience 10 \
    --itr 1 --batch_size 32 --learning_rate 0.001 >logs/RUL/RMixMLP/Best/FD004.log
done
done
